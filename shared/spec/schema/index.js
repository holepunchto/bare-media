...
// @media/create-preview-request.maxSize
const encoding5_1 = c.frame(encoding4)

// @media/create-preview-request
const encoding5 = {
  preencode (state, m) {
    c.string.preencode(state, m.path)
    encoding5_1.preencode(state, m.maxSize)
  ...
  encode (state, m) {
    ...
    encoding5_1.encode(state, m.maxSize)
    c.uint.encode(state, flags)
...
const encoding6_1 = c.frame(encoding3)
...
function getEncoding (name) {
  switch (name) {
    ...
    case '@media/preview': return encoding3
